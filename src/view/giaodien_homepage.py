...
class HomePageUI(QMainWindow):
    def __init__(self):
        ...
        self.image_dir = os.path.join(os.path.dirname(os.path.dirname(self.current_dir)), "trang_tri", "images")
    ...
    def create_navbar(self):
        ...
        pixmap=QPixmap(os.path.join(self.image_dir, "avatar.png")).scaled(36, 36, Qt.AspectRatioMode.KeepAspectRatio, Qt.TransformationMode.SmoothTransformation)
    ...
    def create_profile_section(self):
        ...
        pixmap_large = QPixmap(os.path.join(self.image_dir, "avatar.png")).scaled(120, 120, Qt.AspectRatioMode.KeepAspectRatio, Qt.TransformationMode.SmoothTransformation)
        ...
        self.settings_btn.setFixedSize(140, 40)
    ...
    def create_learning_path_section(self):
        ...
        card_a1 = self.create_course_card(
            ...
            "Unlock and learn basic vocabulary.", [("Unlocked", "#00C853"), ("Locked", "#FF5252")], "a1.png"
        )
        card_b1 = self.create_course_card(
            "#7C4DFF", "Intermediate\nB1", "Intermediate", "Enhance your skills",
            "Learn more complex words and phrases.", [("Locked", "#FF5252")],"b1.png"
        )
        card_c1 = self.create_course_card(
            "#FFD600", "Advanced\nC1", "Advanced", "Master vocabulary",
            "Prepare for advanced English communication.", [("Locked", "#FF5252")], "c1.png"
        )
    ...
    def create_course_card(self, color, level_text, title, subtitle, desc, badges, icon_path):
        ...
        img_path = os.path.join(self.image_dir, icon_path)
    ...
    def create_progress_section(self):
        ...
        pixmap_dino = QPixmap(os.path.join(self.image_dir, "khunglong_streak.png")).scaled(150, 150, Qt.AspectRatioMode.KeepAspectRatio,
                                                             Qt.TransformationMode.SmoothTransformation)
    ...
    def create_vocabulary_section(self):
        ...
        title.setFont(QFont("Arial", 28, QFont.Weight.Bold))
        self.btn_create_vocab = QPushButton("Create New Vocabulary")
        self.btn_create_vocab.setFixedSize(200, 45)
        self.btn_create_vocab.setStyleSheet("background-color: #3CB371; color: white; border-radius: 8px; font-weight: bold;")

        l_layout.addWidget(title)
        l_layout.addWidget(self.btn_create_vocab)
        ...
        pixmap_voca = QPixmap(os.path.join(self.image_dir, "Flashcard.png")).scaled(40, 40, Qt.AspectRatioMode.KeepAspectRatio, Qt.TransformationMode.SmoothTransformation)
    ...
    def create_topics_grid(self):
        ...
        self.danh_sach_the = []
        topics = [
            ("Greetings", "Unlocks at Level 1", "Unlocked", "#3CB371", "greet.png"),
            ("Education", "Unlocks at Level 1", "Unlocked", "#3CB371", "culture.jpg"),
            ("Travel and Culture", "Unlocks at Level 1", "Unlocked", "#3CB371", "travel.png"),
            ("Work", "Locked", "Locked", "#FF5252", "work.png"),
            ("Health", "Locked", "Locked", "#FF5252", "health.png")
        ]
    ...
    def create_topic_card(self, title, sub, status, s_color, topic_icon):
        ...
        img_label.setStyleSheet(f"""
                    #topic_img {{
                        border-image: url("{os.path.join(self.image_dir, topic_icon).replace('\\', '/')}") 0 0 0 0 stretch stretch;
