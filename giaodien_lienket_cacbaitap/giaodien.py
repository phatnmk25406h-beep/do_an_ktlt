...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        # Lấy "tọa độ" tuyệt đối của thư mục giaodien_lienket_cacbaitap
        current_dir = os.path.dirname(os.path.abspath(__file__))

        # 1. Đường dẫn cho ảnh Flashcard
        path_flashcard = os.path.join(current_dir, "images", "Flashcard.png")
        # Thay QPixmap("images/Flashcard.png") thành QPixmap(path_flashcard)

        # 2. Đường dẫn cho ảnh Điền từ vào chỗ trống
        path_duclo = os.path.join(current_dir, "images", "duc_lo.png")
        # Thay QPixmap("images/duc_lo.png") thành QPixmap(path_duclo)

        # 3. Đường dẫn cho ảnh Xếp thứ tự
        path_xeptu = os.path.join(current_dir, "images", "xep_thu_tu.png")
